...
-- Fix some duplicate door spawns
DELETE FROM spawnlist_door WHERE id = 792;
DELETE FROM spawnlist_door WHERE id = 1033;
DELETE FROM spawnlist_door WHERE id = 1151;
DELETE FROM spawnlist_door WHERE id = 1197;
DELETE FROM spawnlist_door WHERE id = 1232;
DELETE FROM spawnlist_door WHERE id = 1234;
