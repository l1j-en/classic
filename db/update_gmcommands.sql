...
REPLACE INTO commands (`name`, `access_level`, `class_name`, `help_text`, `run_on_login`) VALUES('appearoffline', '100', 'L1AppearOffline', 'Hides you from the /who command.', 0);
REPLACE INTO commands (`name`, `access_level`, `class_name`, `help_text`, `run_on_login`) VALUES('snoop', '100', 'L1Snoop', 'View a users inventory, storage, elf storage, or pledge storage.', 0);
REPLACE INTO commands (`name`, `access_level`, `class_name`, `help_text`, `run_on_login`) VALUES('follow', '100', 'L1Follow', 'Makes your character auto-follow the specified player.', 0);
REPLACE INTO commands (`name`, `access_level`, `class_name`, `help_text`, `run_on_login`) VALUES('lazygm', '100', 'L1LazyGm', 'Loops through online players, teleporting you to each of them for x seconds and auto-following them.', 0);
...
INSERT INTO `commands` (`name`, `access_level`, `class_name`, `help_text`, `run_on_login`) VALUES('spoof', 100, 'L1SpoofName', 'Allows you to appear as a different name.', 0);
INSERT INTO `commands` (`name`, `access_level`, `class_name`, `help_text`, `run_on_login`) VALUES('cancel', 100, 'L1Cancel', 'Cancels all skills on a user.', 0);
INSERT INTO `commands` (`name`, `access_level`, `class_name`, `help_text`, `run_on_login`) VALUES('scan', 100, 'L1ScanArea', 'Scans the area and returns details about the subject of the scan.', 0);
INSERT INTO `commands` (`name`, `access_level`, `class_name`, `help_text`, `run_on_login`) VALUES('promote', '200', 'L1Promote', 'Modifies a players access level.', 0);
