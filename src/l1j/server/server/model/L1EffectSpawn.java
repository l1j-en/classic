...
public class L1EffectSpawn {
	...
	/**
	 * Set up an object and effect
	 * 
	 * @param npcid NPC effects templates ID
	 * @param time Presence time (ms)
	 * @param locX Coordinate the establishment X
	 * @param locY Coordinate the establishment Y
	 * @param mapId Set up a map ID
	 * @return Effects generated by the object
	 */
